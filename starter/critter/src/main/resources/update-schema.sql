...
ALTER TABLE schedule_employee
    ADD CONSTRAINT fk_schemp_on_employee FOREIGN KEY (employee_id) REFERENCES employee (id);

ALTER TABLE schedule_employee
    ADD CONSTRAINT fk_schemp_on_schedule FOREIGN KEY (schedule_id) REFERENCES schedule (id);

ALTER TABLE schedule_pet
    ADD CONSTRAINT fk_schpet_on_pet FOREIGN KEY (pet_id) REFERENCES pet (id);
