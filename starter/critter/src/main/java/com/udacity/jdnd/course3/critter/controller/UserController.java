...
public class UserController {
    ...
    public List<CustomerDTO> getAllCustomers() {
        ...
        if(!customers.isEmpty()){
            customerDTOs=  customers.stream().map(this::copyCustomerToDTO).collect(Collectors.toList());
        }
        return customerDTOs;
    ...
    public List<EmployeeDTO> findEmployeesForService(@RequestBody EmployeeRequestDTO employeeDTO) {
        ...
        if(!employees.isEmpty()){
            employeeDTOs=  employees.stream().map(this::copyEmployeeToDTO).collect(Collectors.toList());
        }
        return employeeDTOs;
